...
| --- | --- | --- | --- |
| - Phân tích yêu cầu lưu trữ các thuộc tính thông tin hồ sơ người dùng trong ứng dụng.<br>- Liệt kê các thông tin cần quản lý (mã định danh, email, họ tên, số điện thoại, ảnh đại diện).<br>- Xác định các mốc thời gian tạo và cập nhật dữ liệu.<br>- Đăng bài Blog 3: 5 Sai Lầm Kinh Điển Khi Triển Khai Kiến Trúc Serverless Với AWS Lambda lên AWS Study Group VN. | 27/07/2026 | 27/07/2026 | [DynamoDB Core Components](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.CoreComponents.html) |
...
| - Chạy script kiểm thử thêm và truy xuất dữ liệu mẫu trên DynamoDB.<br>- Theo dõi và kiểm tra chỉ số độ trễ phản hồi của cơ sở dữ liệu.<br>- Hoàn tất nghiệm thu đồ án SmartDocAI và sẵn sàng báo cáo hội đồng. | 01/08/2026 | 01/08/2026 | |
