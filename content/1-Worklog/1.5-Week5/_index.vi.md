...
| - Thực hiện kiểm thử toàn bộ chuỗi tính năng xác thực người dùng.<br>- Kiểm tra luồng Đăng ký, Xác nhận OTP và Đăng nhập nhận JWT Token.<br>- Xử lý các trường hợp ngoại lệ và kiểm soát lỗi dữ liệu không hợp lệ. | 25/07/2026 | 25/07/2026 | |
